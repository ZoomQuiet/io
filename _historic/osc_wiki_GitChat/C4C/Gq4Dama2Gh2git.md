...
故事是这样的,
早期的Rails多人协作开发团队,在代码提交和协作时遇到了很多的麻烦. 
为了解决团队之间开发协作困难的这一个问题,创始人Scott和其他3个程序员朋友,决定完善一个基于Git的代码分支管理工具,用来帮助Rails项目本身的开发.
...
将原先分散的, 各自独立的平台中, 一个新特性从代码到任务/测试/bug 对应的太多分散资源,
集中在了一起;爽利太多, 
干脆就将此工具, 独立发布成为了一个全新的 git 托管平台:
...
问题是 gh 并不是单纯的 geek 产品, 人家是成功的商业平台!
...
所以, gh 已经对 git 的功能拓展了很多,
但是, 一点也没有引发学习, 自然的就用起来了...
...
- [GC4g56: 和合技~强释 - 简书](http://www.jianshu.com/p/aaf4096bde08)
- [S07E15g193: 嗯哼重来 - 简书](http://www.jianshu.com/p/04b10e675998)
- 简单的说:
    + 利用 commit-comment 界面
    + 可以欢快的组织大家进行写作的 `和合技`
    + 高效的在同一个界面完成文字的
    + 逐行/段/篇 讨论/改进
    + 再依赖版本, 逐层推进文字的凝练
