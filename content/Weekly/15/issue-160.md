...
就是 `C`ommand-line `A`pp for `R`apidly `R`emoving `O`bstacles to `L`earning `L`ogic
即,命令行上的经典逻辑推演学习工具.
...
pansop.com
Shared by @mgrouchy
- [在数据库间移动海量数据](http://www.machinalis.com/blog/moving-data-between-databases/)
实用技巧,
有关将数据从 MySQL 迁移到 pg.
machinalis.com
Shared by @mgrouchy
