...
- [了解Python的下划线](https://hackernoon.com/understanding-the-underscore-of-python-309d1a029edc)
  - core-python
While the underscore _is used for just snake-case variables and functions in most languages (Of course, not for all), but it has special meanings in Python. If you are python programmer, for_ in range(10) , **init**(self) like syntax may be familiar.
